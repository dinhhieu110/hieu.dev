  ...
  return (
    <div className='flex flex-col xl:flex-row gap-8'>
      ...
      <div className='flex flex-col gap-4 xl:w-2/3'>
        <Link to="/" className='text-4xl font-semibold'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut rei aliquid quo Dolorem.</Link>
        ...
        <Link className='underline text-sm text-primary-gradient'>Read More</Link>
      </div>
    </div>
  )
}
